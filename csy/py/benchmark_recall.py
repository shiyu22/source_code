...
file_index = 0
FOLDER_NAME = '/home/pensees/feature_compare/card_72_csv'
# FOLDER_NAME ='/feature'
NQ = 0
TOPK = 0
ALL = False
...
def main():
    try:
        opts, args = getopt.getopt(
            sys.argv[1:],
            "hlsgtan:m:q:k:bdp",
            ["help", "list", "search","generate","build","transform","delete","nb=","ivf=","flat=","table=","num=","nq=","topk=","index=","rows","show","compare","add"],
        )
