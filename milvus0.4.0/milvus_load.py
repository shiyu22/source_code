...
FILE_NPY_PATH = '/data/lcl/200_ann_test/source_data'
    ...
    for opt_name, opt_value in opts:
        if opt_name in ("-t", "--table"):
            ...
            for filename in filenames:
                ...
                # print(id_index, " ", id_index+len(vectors))
                # vectors_ids = [id for id in range(id_index,id_index+len(vectors))]
                # id_index = id_index + len(vectors)
                vectors_ids = []
